...
Mario.Character.prototype.Move = function() {
    ...
    // Accroupissement avec la touche fléchée du bas ou 'S'
    if (this.OnGround) {
        if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Down) && this.Large) || 
            (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.S) && this.Large)) {
            this.Ducking = true; // S'accroupir
        } else {
            this.Ducking = false; // Ne pas s'accroupir
        }
    }
    ...
    // Sauter avec la touche fléchée du haut ou 'Z'
    if (Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Up) || 
        Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Z) || 
        Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Space) ||
    ...
    // Mouvement à gauche avec 'Q' et à droite avec 'D'
    if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Q) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left)) && !this.Ducking) {
        if (this.Facing === 1) {
            this.Sliding = false;
        }
    ...
    if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.D) || Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right)) && !this.Ducking) {
        if (this.Facing === -1) {
            this.Sliding = false;
        }
        this.Xa += sideWaysSpeed;
    ...
    if ((!Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Q) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.D) &&
         !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Left) && !Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.Right)) ||
        this.Ducking || this.Ya < 0 || this.OnGround) {
        this.Sliding = false;  
    }

    if ((Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.E)||Enjine.KeyboardInput.Pressed["LeftClick"]) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2) {
