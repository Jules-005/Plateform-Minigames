...
<ul class="list-group">
<li class="list-group-item"> <kbd>P</kbd><br>Pause </li>
<li class="list-group-item"> <kbd>R</kbd><br>Rotation</li>
<li class="list-group-item"> <kbd>Fleches de directions</kbd><br>Déplacez la figure dans cette direction</li>
</ul>
`);
    }
    ...
    mainLoop() {
        ...
        if (this.figureCanMoveDown()) {
            ...
            setTimeout(() => {
                ...
                if (this.playerLoses()) {
                    Swal.fire("Jeux terminer", "Essaye encore");
                    this.sounds.background.pause();
                    this.canPlay = false;
                    this.resetGame();
                    return;
    ...
    async askUserConfirmResetGame() {
        ...
        const result = await Swal.fire({
            title: 'Redémarrer',
            text: "Voulez-vous redémarrer le jeu ?",
            icon: 'question',
