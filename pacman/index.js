...
const keys = {
  z: { // Changement de w à z
    pressed: false,
  },
  q: { // Changement de a à q
    pressed: false,
  },
  s: { // Pas de changement ici
    pressed: false,
  },
  d: { // Pas de changement ici
    pressed: false,
  },
}
...
function animate() {
  ...
  if (keys.z.pressed && lastKey === 'z') player.move('up');    // Utilise 'up' pour Z
  else if (keys.q.pressed && lastKey === 'q') player.move('left'); // Utilise 'left' pour Q
  else if (keys.s.pressed && lastKey === 's') player.move('down');  // Utilise 'down' pour S
  else if (keys.d.pressed && lastKey === 'd') player.move('right'); // Utilise 'right' pour D
